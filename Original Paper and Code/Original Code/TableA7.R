################################################################
###### Table A.7: Effect of Riot Destruction on Prosocial ######
######            Behavior (controlling for confounders)  ######
################################################################
...
stargazer(model1, model2, model3, model4, model5, 
          covariate.labels = c("Destruction", "Wealth index", "State capacity index", "Community policing index", "Accessibility index"),
          ...
          star.char = c("*", "**", "***"),
          title = "Table A.7: Effect of Riot Destruction on Prosocial Behavior (controlling for confounders)",
