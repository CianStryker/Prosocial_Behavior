#################################################################
##### Figure A.19: Effect of Riot Destruction on Prosocial ######
##### Behavior (autocorrelation adjusted, no imputation)   ######
#################################################################
...
matrix <- read.csv("z.distance_matrix_A.csv")
...
figureA19 <- ggplot(allModelFram, aes(shape=matrix_style)) + 
