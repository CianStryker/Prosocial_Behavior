...
load("Appendix/Appendix_Data/kyrgyzstan.RData")
data <- table
...
DistMat <- as.data.frame(read.csv("Appendix/Appendix_Data/distances_ri.csv", header = TRUE, sep =","))[-1]
...
eoa <- as.data.frame(read.csv("Appendix/Appendix_Data/ri_east_of_akbuura.csv", header = TRUE))[2]
DistMat$eoa <-eoa
